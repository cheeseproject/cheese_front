        ...
        <SafeAreaView style={styles.container}>
                ...
                <View style={styles.profileInfo}>
                    ...
                    <View>
                        ...
                        >
                            <ToggleButton icon={require("../../assets/profile/post.png")} iconColor={isActive("post") ? 'white':"#222"} value="post" style={isActive("post") ? styles.checkedBtn : styles.uncheckedBtn}/>
                            <ToggleButton icon={require("../../assets/profile/like.png")} iconColor={isActive("like") ? 'white':"#222"} value="like" style={isActive("like")?styles.checkedBtn:styles.uncheckedBtn}/>
                        </ToggleButton.Row>
                    </View>
                </View>
                <View style={{ flexDirection: 'row',overflow:"scroll",maxHeight:270,backgroundColor:"#f0f0f0" }}>
                    <FlatList
